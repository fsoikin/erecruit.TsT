...
module erecruit.TsT.Tests {
	...
	function trimAndUnwrapAll( types: Type[], trimComments: boolean = true ) {
	...
	/* Removes unnecessary back references and unwraps lazy evaluators for better readability of error messages */
	function trimAndUnwrap( type: Type, trimComments: boolean = true ): Type {
	...
	function trimAndUnwrapIntf( i: Interface, trimComments: boolean = true ): Interface {
