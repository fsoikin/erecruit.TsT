...
namespace vs_UnitTests.MenuItemTests
{
	[TestClass()]
	public class MenuItemTest
	{
		...
		public void InitializeMenuCommand() {
			// Create the package
			IVsPackage package = new vsPackage() as IVsPackage;
			...
			CommandID menuCommandID = new CommandID( erecruit.vs.GuidList.guidvsCmdSet, (int)erecruit.vs.PkgCmdIDList.cmdidAddTranslated );
